...
2. [Install R](https://cran.r-project.org/bin/macosx/). Click the release that has title R-Number.Number.Number.pkg (for example R-4.0.5.pkg but this will change in the future).
